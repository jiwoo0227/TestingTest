...
public class TriangleType {
		...
		static final String P_EQUILATERAL = "equilateral";
	 static final String P_ISOSCELES   = "isossceles";
		 static final String P_RIGHTANGLED = "right-angled";
		 static final String P_SCALENE     = "scalene";
		 static final String P_IMPOSSIBLE  = "impossible";
		 ...
		 */
		public TriangleType(int s1, int s2, int s3)
		{
			side1 = s1;
			side2 = s2;
			side3 = s3;
		 ...
		 */
		public TriangleType setSideLengths(int s1, int s2, int s3)
		{
			side1 = s1;
			side2 = s2;
			side3 = s3;
